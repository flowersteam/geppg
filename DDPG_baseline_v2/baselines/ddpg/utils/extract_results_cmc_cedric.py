...
data_path='/media/flowers/3C3C66F13C66A59C/data_save/ddpg_study_baseline/data/MountainCarContinuous-v0/DDPG_OU/'
gep=False

name_run = 'DDPG_OU'
name_algo = 'DDPG with action perturbations'
env_id = 'MountainCarContinuous-v0'

results ='plot_all'#  'compute_stats_from_eval'#   'mean_scores'#   'correlation_gep_ddpg'#  'compute_scores'#  'plot_gep'#  'test_variability'#  'compute_stats_vs' #    'plot_vs'#         'correlation_gep_ddpg'#
